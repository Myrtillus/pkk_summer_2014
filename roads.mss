...
@track-fill: #231700;
@track-grade1-fill: #231700;
@track-grade2-fill: #231700;
...
#roads-casing {
  ...
  [highway = 'road'] {
    [tunnel != 'yes'] {
      ...
      [zoom >= 14] { line-width: @residential-width-z14 + 3.5; }
      [zoom >= 15] { line-width: @residential-width-z15 + 3.8; }
      [zoom >= 16] { line-width: @residential-width-z16 + 3.8; }
      [zoom >= 17] { line-width: @residential-width-z17 + 3.5; }
    }
  }
...
#roads-fill {
  ...
  [feature = 'highway_path'][foot = 'designated'] {
    [zoom >= 13][tunnel != 'yes'] {
      ...
      /* jalankulkupolkujen mtb:scale merkkaus*/
      ["mtb:scale" = "0"]{
        line-width: 4.0;
        line-color:  #66FF00;
        line-opacity: 0.8;
  ...
  [feature = 'highway_path'][bicycle = 'designated'] {
    [zoom >= 13][tunnel != 'yes'] {
      ...
      b/line-join: round;
      b/line-cap: round;
      /* pyöräteiden mtb:scale merkkaus*/
      ["mtb:scale" = "0"]{
        line-width: 4.0;
        line-color:  #66FF00;
        line-opacity: 0.8;
  ...
  [feature = 'highway_track'] {
    [zoom >= 13] {
      ...
      [zoom >= 13][zoom < 14] {
        b/line-width: 2.5;
        //c/line-width: 1.2; 
        c/line-width: 2;   // zoomitasolla 13 katkoviivan leveys sama kaikilla track typeillä
